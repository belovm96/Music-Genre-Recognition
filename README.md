...
In this project, I proposed a Convolutional Neural Network architecture, trained it on the data from GTZAN & FMA datasets, achieving 70% accuracy classifying 10 music genres.
